...
export type TextEditorStore = {
	...
	// header reads it to render the rich-text toolbar inside the navigation
	// bar while the keyboard is open. Cleared on TextEditor unmount so a
	// stale closure can't be invoked after the editor is gone.
