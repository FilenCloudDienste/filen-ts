...
// driveHiddenItems -> secureStore -> expo-secure-store. Stub the accessor it uses; the preference is
// off here, so the notice never fires. isHiddenName now comes from @filen/shared (see filenShared mock).
