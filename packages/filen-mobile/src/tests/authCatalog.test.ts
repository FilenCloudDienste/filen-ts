...
const INTENTIONAL_PLURAL_KEYS = new Set([
	...
	"copy_progress_files_one",
	"copy_progress_files_other",
	"copy_progress_files_speed_one",
	"copy_progress_files_speed_other",
	"copy_stop_message_one",
	"copy_stop_message_other",
	"copy_notes_skipped_one",
	"copy_notes_skipped_other",
	"copy_notes_renamed_one",
	"copy_notes_renamed_other",
	"copy_notes_saved_as_version_one",
	"copy_notes_saved_as_version_other",
	"copy_notes_sharing_not_applied_one",
	"copy_notes_sharing_not_applied_other",
	"copying_items_one",
	"copying_items_other",
	"copying_progress_one",
	"copying_progress_other",
	"upload_complete_one",
