...
import type { CommonKey, DriveKey, PreviewKey, NotesKey, ChatsKey, AudioKey } from "@/lib/i18n"
...
export interface ActionDef {
	...
	defaultCombo: string
	scope: ActionScope
	descriptionKey: CommonKey | DriveKey | PreviewKey | NotesKey | ChatsKey | AudioKey
}
