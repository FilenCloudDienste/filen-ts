...
import { narrowItem, type BaseFileItem, type DriveItem } from "@/lib/drive/item"
import { type ThumbGeneratorCategory, type ThumbGenerator } from "@/lib/drive/thumbnails"
...
vi.mock("@/lib/drive/thumbnails", () => ({ registerThumbGenerator: registerThumbGeneratorMock }))
...
vi.mock("@/lib/drive/download", () => ({ narrowToAnyFile: narrowToAnyFileMock }))
