...
// md note render (read-only — the trashed/history path). A resizable horizontal split (D4 / synthesis
// §3.4): source on the left (read-only CodeMirror in markdown mode), the SAME rendered-markdown surface
