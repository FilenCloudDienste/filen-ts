...
// realtime updates must land while the user is anywhere in the app. On mount it registers the note
// domain's handlers and starts the single subscription; the bridge outlives route navigation. Teardown
