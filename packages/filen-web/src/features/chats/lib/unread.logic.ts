...
// Per-conversation unread derivation — PURE. D4: in-app unread signals are DERIVED client-side (mobile's
...
// comparing to the bigint userId, never `===` raw (wasm-chats §2.4). The blocked-sender refinement mobile
// adds needs the contacts blocking model cross-referenced — deferred to a later wave, same as the sidebar
