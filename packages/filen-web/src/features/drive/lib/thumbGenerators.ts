...
// Persisting the generated bytes (storeThumbnail) is NOT this generator's job — lib/drive/thumbnails.ts's
...
export const generatePdfThumb: ThumbGenerator = async item => {
	...
	// thumbnail — pdf-viewer.tsx can import it statically because that whole component is itself
	// route/lazy-split, which this plain module is not.
	const { getDocument, GlobalWorkerOptions } = await import("pdfjs-dist")

	// Mirrors pdf-viewer.tsx's own worker-src setup (duplicated rather than imported: that file is a
...
// new-directory.tsx's own module-scope registerAction call). lib/drive/thumbnails.ts (the service)
