...
// The grid tile's video-type badge (mobile parity: a play-glyph badge marks video items) reuses
// previewType (the SAME category resolution canPreview/the preview overlay itself use), so a
