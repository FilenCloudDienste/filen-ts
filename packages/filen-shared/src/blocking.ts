...
// deriveBlockedUsers populates the set). Both identity fields are optional on the caller's side:
// a resolved shared-item identity always carries both, but this stays permissive for any future
// caller that only has one of the two.
